...
public class Reports_ROVORowImpl extends ViewRowImpl {
    ...
    public enum AttributesEnum {
        ...
        reportsCount {
            public Object get(Reports_ROVORowImpl obj) {
                return obj.getreportsCount();
            }

            public void put(Reports_ROVORowImpl obj, Object value) {
                obj.setreportsCount((Integer)value);
            }
        }
        ,
        Functions_VO1 {
        ...
        ,
        FuncBasedOnRoleROVO1 {
            public Object get(Reports_ROVORowImpl obj) {
                return obj.getFuncBasedOnRoleROVO1();
            }
    ...
    public static final int REPORTSCOUNT = AttributesEnum.reportsCount.index();
    ...
    public static final int FUNCBASEDONROLEROVO1 = AttributesEnum.FuncBasedOnRoleROVO1.index();
    ...
    public String getReport() {
        if(null == getAttributeInternal(REPORT)){
            if(getFuncBasedOnRoleROVO1().first()!=null){
                return getFuncBasedOnRoleROVO1().first().getAttribute("FuncId").toString();
            }
        }
        else{
    ...
    public String getReportPath() {
        if(null == getAttributeInternal(REPORTPATH)){
            if(getFuncBasedOnRoleROVO1().first()!=null){
                return getFuncBasedOnRoleROVO1().first().getAttribute("PagePath").toString();
            }
        }
        else{
    ...
    /**
     * Gets the attribute value for the calculated attribute reportsCount.
     * @return the reportsCount
     */
    public Integer getreportsCount() {
        return (Integer) getAttributeInternal(REPORTSCOUNT);
    }

    /**
     * Sets <code>value</code> as the attribute value for the calculated attribute reportsCount.
     * @param value value to set the  reportsCount
     */
    public void setreportsCount(Integer value) {
        setAttributeInternal(REPORTSCOUNT, value);
    }
    ...
    /**
     * Gets the view accessor <code>RowSet</code> FuncBasedOnRoleROVO1.
     */
    public RowSet getFuncBasedOnRoleROVO1() {
        return (RowSet)getAttributeInternal(FUNCBASEDONROLEROVO1);
    }
